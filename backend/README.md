...
## Project Structure
    ...
    ├── renaissance_wigs_36246  # Django project configurations
...
1. Clone this repo and `cd renaissance_wigs_36246`
...
2. Clone this repo and `cd renaissance_wigs_36246`
